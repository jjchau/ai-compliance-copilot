...
class TestHasConflictingSignals:
    def test_aggressive_and_conservative_signals(self, monkeypatch):
        ...
        monkeypatch.setattr(cd_mod, 'is_investment_too_aggressive_for_horizon', lambda t: False)
    ...
    def test_all_aggressive_signals(self, monkeypatch):
        ...
        monkeypatch.setattr(cd_mod, 'is_investment_too_aggressive_for_horizon', lambda t: True)
